...
Jede Uhrzeiten wird mithilfe der Funktion \ttt{timeToMinutes()} zu Stunden bzw. zu Minuten umgewandelt.
...
In diesem \ttt{vector} steht jede gerade bzw. ungerade Zahl für die Öffnungs-- bzw. Schließungszeit. 
