...
\begin{itemize}
	...
	\begin{itemize}
		...
		Einfügen--Operation in eine \ttt{list} in C++ erfolgt in $O(1)$.\footnote{\href{https://en.cppreference.com/w/cpp/container/list/insert}{https://en.cppreference.com/w/cpp/container/list/insert}}
